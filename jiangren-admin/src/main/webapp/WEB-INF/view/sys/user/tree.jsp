    ...
    $(function () {
        var setting = {
            ...
            callback : {
                onClick : function(event, treeId, treeNode) {
                    parent.frames['content'].location.href = "${ctx}/user/list?organizationId="+treeNode.id;
                }
            }
        };
        var zNodes =[
        ...
        $(document).ready(function(){
            ...
            if(nodes.length>0){
                ...
                parent.frames['content'].location.href = "${ctx}/user/list?organizationId="+nodes[0].id;
            }
        });
    });
</script>
